<template>
    <article class="w-1/3 px-7 py-5 bg-blue-950/60 rounded-lg shadow-gray-100/30 shadow-sm">
        <header class="mb-5">
        ...
        <section class="mb-7">
            <article class="mb-3">
                ...
                <NInput 
                    ...
                    :placeholder="PLACEHOLDER_AUTH_CORREO" 
                    type="text"/>
            </article>
            <article>
                ...
                <NInput 
                    ...
                    :placeholder="PLACEHOLDER_AUTH_PASSWORD" 
                    type="password"/>
            </article>
        </section>
        <footer>
...
const { credenciales, iniciarSesion } = inject('auth-login')
</script>